...
function CoursePreview({ course }: CoursePreviewProps) {
  ...
  return (
    <div className="course-preview">
      ...
      <div className="course-preview__container">
        <h3 className="text-xl mb-4">Price Details (1 items)</h3>
        <div className="flex justify-between mb-4 text-customgreys-dirtyGrey border-t border-customgreys-dirtyGrey pt-4">
